...
> If you want to ask a question, please first read the available
> [Documentation](/docs).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/dplassgit/d2lang/issues) that might help you. In
...
> ### Legal Notice When contributing to this project, you must agree that you
> have authored 100% of the content, that you have the necessary rights to the
> content and that the content you contribute may be provided under the project
> license.

### AI-generated code

If you use an AI agent to generate or update code or documentation, you MUST
indicate that in the pull request. You can use `#ai-generated` or
...
information. Therefore, we ask you to investigate carefully, collect data and
...
- Determine if your bug is really a bug and not an error on your side, e.g.,
  ...
  read the [documentation](/docs). If you are looking for support, you might
...
- To see if other users have experienced (and potentially already solved) the
  ...
  tracker](https://github.com/dplassgit/d2lang/issues?q=label%3Abug).
...
> Instead, sensitive bugs must be sent by email to <security@plasstech.com>.

We use GitHub issues to track bugs and errors. If you run into an issue with
the project:

- Open an [Issue](https://github.com/dplassgit/d2lang/issues/new). (Since we
...
d2lang, **including completely new features and minor improvements to existing
...
- Make sure that you are using the latest version.
- Read the [documentation](/docs) carefully to find out if the functionality
  is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/dplassgit/d2lang/issues) to see if the
...
issues](https://github.com/dplassgit/d2lang/issues).

- Use a **clear and descriptive title** for the issue to identify the
  suggestion.
- Provide a **detailed description of the suggested enhancement** in as
  many details as possible.
- **Describe the current behavior** and **explain which behavior you hoped
  to see instead** and why. At this point you can also tell which alternatives
  do not work for you.
- **Explain why this enhancement would be useful** to most d2lang users. You
...
Review the [documentation](/docs/running.md) which includes installation
instructions.

There are various issues marked [good first
issue](https://github.com/dplassgit/d2lang/labels/good%20first%20issue) that
you can peruse
...
**Except for documentation or extremely trivial changes, all PRs must include
tests.** 

You can optionally include a "sample" file in the
[samples](https://github.com/dplassgit/d2lang/tree/trunk/samples) directory
that exercises the code in the PR.

You should "squash" multiple commits into a single commit for a PR.

One PR should address ONE bug/issue.
...
After the first line, you can add more details to support the description of
the change, e.g., 
...
All BUILD files MUST be formatted using
[buildifier](https://github.com/bazelbuild/buildtools/blob/master/buildifier/README.md)

All Java files MUST be formatted using the [google java
formatter](https://github.com/google/google-java-format)

All .d files should be formatted manually. There is [no d2lang style guide
yet](https://github.com/dplassgit/d2lang/issues/377).


## Attribution

This guide is based on **contributing-gen**. [Make your
