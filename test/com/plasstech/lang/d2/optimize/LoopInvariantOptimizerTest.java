...
public class LoopInvariantOptimizerTest {
  ...
  @Test
  public void oneLoop() {
    assertThatInterpreting("      oneLoop:proc(n:int):int { "
    + "  sum = 0 "
    + "  i = 0 "
    + "  while i < 10 do i = i + 1 {"
    ...
    + "  return sum"
    + "}"
    + "println oneLoop(10)").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }
  ...
  public void simplest_tempInvariant() {
    assertThatInterpreting("      simplest:proc(s:string) { "
    + "  i = 0 while i < length(s) do i = i + 1 {"
    + "    print s[length(s)-1] "
    + "  }"
    + "}"
    + "simplest('hi')").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }

  @Test
  public void oneLoopContinue() {
    assertThatInterpreting("      oneLoopContinue:proc(n:int):int { "
    + "  sum = 0 "
    + "  i = 0 "
    + "  while true do i = i + 1 {"
    + "    x = n + 1 "
    ...
    + "  return sum"
    + "}"
    + "println oneLoopContinue(10)").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }

  @Test
  public void loopNeverRunStatic() {
    assertThatInterpreting("      loopNeverRun:proc(n:int):int { "
    + "  sum = 0 "
    + "  i = 0 x = 0"
    ...
    + "  return sum + x"
    + "}"
    + "println loopNeverRun(10)").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }

  @Test
  public void loopNeverRunDynamic() {
    assertThatInterpreting("      loopNeverRun:proc(n:int, m:int):int { "
    + "  sum = 0 "
    + "  i = 0 x = 0"
    ...
    + "  return sum + x"
    + "}"
    + "println loopNeverRun(10, 20)").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }

  @Test
  public void oneLoopUnary() {
    assertThatInterpreting("      oneLoopUnary:proc(n:int):int { "
    + "  sum = 0 "
    + "  i = 0 "
    + "  while i < 10 do i = i + 1 {"
    + "    x = -n "
    ...
    + "  return sum"
    + "}"
    + "println oneLoopUnary(10)").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }

  @Test
  public void oneLoopBreak() {
    assertThatInterpreting("      oneLoopBreak:proc(n:int):int { "
    + "  sum = 0 "
    + "  i = 0 x = 0"
    + "  while i < 10 do i = i + 1 {"
    + "    x = n + 1 "
    ...
    + "  return sum + x"
    + "}"
    + "println oneLoopBreak(10)").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }
  ...
  public void oneLoopBreakInvariantAfterBreak() {
    ...
    assertThatInterpreting("      oneLoopBreakInvariantAfterBreak:proc (n:int):int { "
    + "  sum = 0 "
    + "  i = 0 x = 0"
    + "  while i < 10 do i = i + 1 {"
    + "    break"
    ...
    + "  return sum + x"
    + "}"
    + "println oneLoopBreakInvariantAfterBreak(10)").withOptimizer(ilOptimizer).hasSameVariables();
  }
  ...
  public void oneLoopGlobal() {
    assertThatInterpreting("      lexer_text: string "
    + "lexer_loc=0 "
    + "lexer_cc='' "
    ...
    + "pi = makeInt() "
    + "println pi ").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }

  @Test
  public void oneLoopGlobalSmaller() {
    assertThatInterpreting("      lexer_text='314159 ' // full text "
  ...
  public void nestedLoopsGlobals() {
    ...
    + "  sum = sum + i "
    + "} "
    + "println sum").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }

  @Test
  public void nestedLoopsLocals() {
    assertThatInterpreting("      nestedLoopsLocals:proc(n:int):int { "
    + "  sum = 0 "
    + "  x = 0 "
    + "  y = 0 "
    + "  z = 0 "
    ...
    + "  return sum * z + x - y"
    + "}"
    + "println nestedLoopsLocals(10)").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }

  @Test
  public void twoNestedLoopsWithInvariants() {
    assertThatInterpreting("      twoNestedLoopsWithInvariants:proc(n:int):int { "
    + "  sum = 0 "
    + "  x = 0 "
    + "  y = 0 "
    + "  i = 0 while i < n do i = i + 1 { "
    ...
    + "  return sum + x - y"
    + "}"
    + "println twoNestedLoopsWithInvariants(10)").withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }

  @Test
  public void twoNestedLoops() {
    assertThatInterpreting("      twoNestedLoops:proc(n:int):int { "
    + "  sum = 0 "
    + "  i = 0 while i < n do i = i + 1 { "
    + "    j = 0 while j < n do j = j + 1 { "
    + "      sum = sum + i "
    ...
    + "  return sum"
    + "}"
    + "println twoNestedLoops(10)").withOptimizer(loopOptimizer).hasSameVariables();
  }

  @Test
  public void recordModifiedInCall() {
    assertThatInterpreting("      r: record{i:int}"
    + "updaterec: proc(rec:r) { rec.i = rec.i + 1 }"
    + "recordloopinvariant: proc(rec:r): int {"
    + "  while rec.i < 10 { updaterec(rec) }"
    + "  return rec.i"
    + "}"
    + "print recordloopinvariant(new r)").withOptimizer(loopOptimizer).hasSameVariables();
  }
  ...
  public void recordModifiedInCallGlobal() {
    ...
    + "print rec.i").withOptimizer(loopOptimizer).hasSameVariables();
  }
  ...
  public void recordLoopInvariant() {
    assertThatInterpreting(TestCode.RECORD_LOOP_INVARIANT).withOptimizer(loopOptimizer).hasSameVariables();
  }

  @Test
  public void recordLoopNonInvariant() {
    assertThatInterpreting(TestCode.RECORD_LOOP_NOT_INVARIANT).withOptimizer(loopOptimizer).hasSameVariables();
  }

  @Test
  public void recordLoopInvariant_loopAndConstantOptimizers() {
    assertThatInterpreting(TestCode.RECORD_LOOP_INVARIANT).withOptimizer(loopAndConstantOptimizer).hasSameVariables();
  }
}
