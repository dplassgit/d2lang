...
public class LoopInvariantOptimizerTest {
  ...
  private ILOptimizer loopAndConstantOptimizer =
      new ILOptimizer(
          ImmutableList.of(new NopOptimizer(), new ConstantPropagationOptimizer(0), loopOptimizer),
          0);
  ...
  public void oneLoop() {
    assertThatInterpreting(
            ...
            println oneLoop(10)
            """)
        .withOptimizer(loopAndConstantOptimizer)
        .hasSameVariables();
  }
  ...
  public void simplest() {
    ...
    Transfer transferToX =
        new Transfer(
            LocationUtils.newStackLocation("x", VarType.INT, 4), ConstantOperand.ZERO, null);
  ...
  private static int findMatchingOp(ImmutableList<Op> ilCode, Predicate<Op> predicate) {
    return (int) ilCode.stream().takeWhile(predicate).count();
  }
  ...
  public void oneLoopBreakInvariantAfterBreak() {
    ...
    ILOptimizer ilOptimizer =
        new ILOptimizer(
            ImmutableList.of(new NopOptimizer(), new DeadCodeOptimizer(0), loopOptimizer), 2);
    assertThatInterpreting(
            """
  ...
  public void recordLoopNonInvariant() {
    assertThatInterpreting(TestCode.RECORD_LOOP_NOT_INVARIANT)
        .withOptimizer(loopOptimizer)
        .hasSameVariables();
  }
