...
public class NasmCodeGeneratorStringTest {
  ...
  public void negativeIndex() throws Exception {
    assertThatCompiling("s='hello' print s[-2]")
        .withOptimize(false)
        .hasCompileTimeError("Index of STRING variable 's' must be non-negative; was -2");
    assertThatCompiling("f:proc() {s='hello' print s[-3]} f()")
        .withOptimize(false)
  ...
  public void oobeIndexNoOpt() throws Exception {
    ...
    assertThatCompiling(sourceCode)
        .withOptimize(false)
        .withRuntimeError("STRING index out of bounds (length 5); was 10")
        .executes();
  }
  ...
  public void negativeIndexLocalNoOpt() throws Exception {
    ...
    assertThatCompiling(sourceCode)
        .withOptimize(false)
        .withRuntimeError("must be non-negative; was -2")
        .executes();
  }
  ...
  public void lengthNullLocal() throws Exception {
    ...
    assertThatCompiling(program).withOptimize(false).withRuntimeError("Null pointer").executes();
  }
  ...
  @Test
  public void stringLength(@TestParameter({"", "s", "hello"}) String value) throws Exception {
