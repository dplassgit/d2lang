  ...
  public void allOpsGlobals() throws Exception {
    execute(
        "      a=0y2 "
            ...
            + " k=z+0y4/(0y5+(0y4-0y5*f)) println k"
            + " k=0y0+d/(0y5+(0y4-0y5*f)) println k"
            + " g=a+a*(b+(b+c*(d-(c+d/(e+(d-e*f)))))) println g"
            + " h=0y0+a+(0y4+0y3*(0y4-(0y3+0y4/(0y4+(0y5-e*0y6))))) println h"
            + " j=a+a*(b+(b+c*(d-(c+d/(e+(d-e*f+0y0)))))) println j"
            + " aa=0y2+a*(0y3+(0y3+0y5*(0y7-(0y5+0y7/0y11)+(0y7-0y11*0y13))*0y2)/b) println aa"
            + "",
        "allOpsGlobal");
  }
