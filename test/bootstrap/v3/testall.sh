...
VEXE="bazel-bin/src/bootstrap/v3/v3fromv3.exe"

bazel build //src/com/plasstech/lang/d2:D2Compiler //src/bootstrap/v1:v1.d //src/bootstrap/v2:v2.d //src/bootstrap/v3:v3fromv3exe || exit -7
