...
VEXE="bazel-bin/src/bootstrap/v4/v4fromv4.exe"

bazel build //src/com/plasstech/lang/d2:D2Compiler //src/bootstrap/v1:v1.d //src/bootstrap/v2:v2.d //src/bootstrap/v3:v3.d //src/bootstrap/v4:v4fromv4exe || exit -7
