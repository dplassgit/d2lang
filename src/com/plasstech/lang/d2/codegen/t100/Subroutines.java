...
class Subroutines {
  ...
  private static final List<String> COPY32_CODE =
      ImmutableList.<String>builder()
          ...
          .add("  jmp " + Name.D_copyN.name())
          .build();

  private static final List<String> COPYN_CODE =
      ImmutableList.<String>builder()
          .add("\n; Copies D bytes from BC to HL: [HL] = [BC] ")
          .add("; Destroys A")
          .add(Name.D_copyN.name() + ":")
          .add("  push B")
          .add("  push D")
          .add("  push H")
          .add(Name.D_copyN.name() + "_loop:")
          .add("  ldax B  ; read from source")
          .add("  mov M, A  ; write to dest")
          .add("  inx B   ; next byte")
          .add("  inx H")
          .add("  dcr D")
          .add("  jnz " + Name.D_copyN.name() + "_loop")
          .add("  pop H")
          .add("  pop D")
          .add("  pop B")
          .add("  ret")
  ...
  private static final ImmutableSet<Subroutine> SUBROUTINE_SET =
      ImmutableSet.<Subroutine>builder()
          ...
          .add(new Subroutine(Name.D_copyN, COPYN_CODE))
