...
class SingleLinePatternOptimizer extends Optimizer {
  ...
  private static final ImmutableMap<String, String> PATTERNS = ImmutableMap.of(
      ...
      "^  add " + MAYBE_MODIFIER + "(" + Registers.REGISTER + "), 1 *$", "  inc $2",
      "^  sub " + MAYBE_MODIFIER + "(" + Registers.REGISTER + "), 1 *$", "  dec $2",
      "^  inc " + MODIFIER + " +" + "(" + Registers.REGISTER + ")*$", "  inc $2",
      "^  dec " + MODIFIER + " +" + "(" + Registers.REGISTER + ")*$", "  dec $2",
      "^  add (.*), 1 *$", "  inc $1",
      "^  sub (.*), 1 *$", "  dec $1",
      "^  mov " + MAYBE_MODIFIER + "(" + Registers.REGISTER + "), 0 *$", "  xor $2, $2");
